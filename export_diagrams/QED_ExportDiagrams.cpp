...
int main(int argc, char *argv[]){
    ...
    cout << "diagrams:" << endl;
    cout << process_ampl.obtainGraphs() << endl;
    // SaveDiagrams("diagrams.json", process_ampl);
    auto diagrams = process_ampl.obtainGraphs();
    auto diagrams_built = Drawer::buildDiagrams(diagrams);
    cout << diagrams_built[0] << endl;
    // Drawer::saveToJSON("diagrams.json", diagrams, true);
    cout << "nodes:" << endl;
    cout << diagrams[0]->getNodes()[0] << endl;
    cout << "vertices:" << endl;
    auto vertices = diagrams[1]->getVertices();
    cout << vertices << endl;
    // cout << vertices[0].getFirstContractibleField() << endl;
    // cout << Drawer::convertGraph(diagrams[0]) << endl;
    // cout << diagrams[0]->getFactor() << endl;
    // cout << diagrams[0]->getFields() << endl;
    // Show(diagrams);
